        ...
        <section className="relative bg-navy pt-16 md:pt-24 pb-0 px-6 md:px-8 flex flex-col items-center text-center overflow-hidden">
            <div className="max-w-3xl mx-auto space-y-8 z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2">
                    <button className="bg-white text-navy px-8 py-3 rounded-md font-bold text-base hover:bg-gray-100 transition-all">
                        Talk to us
                    </button>
                    <button className="border border-white/40 text-white px-8 py-3 rounded-md font-bold text-base hover:bg-white/10 transition-all">
                        Join our Waitlist
                    </button>
                </div>
            </div>

            <div className="mt-12 md:mt-16 w-full max-w-4xl mx-auto relative translate-y-12 md:translate-y-16">
                <img
                    src={heroImg}
