...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-12 py-5 bg-white sticky top-0 z-50 border-b border-gray-50">
            ...
            {mobileOpen && (
                <div className="absolute top-full left-0 right-0 bg-white border-b border-gray-100 shadow-lg md:hidden z-50">
                    <div className="flex flex-col px-6 py-4 gap-4 text-navy font-bold text-base">
                        <a href="#about" onClick={() => setMobileOpen(false)} className="py-2 border-b border-gray-50">about</a>
                        <a href="#capabilities" onClick={() => setMobileOpen(false)} className="py-2 border-b border-gray-50">capabilities</a>
